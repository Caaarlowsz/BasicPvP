					...
					try {
						...
						try {
							...
							try {
								...
								player.sendMessage(Strings.getPrefixo() + " §aVocê se teleportou até as coordenadas "
										+ x + ", " + y + ", " + z + ".");
					...
					if (target != null) {
						if (args.length == 2) {
							...
							if (target2 != null) {
								...
								player.sendMessage(Strings.getPrefixo() + " §cO seu segundo alvo não foi encontrado.");
						} else {
